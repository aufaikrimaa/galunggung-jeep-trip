      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-black/80 backdrop-blur-md py-4" : "bg-transparent py-6"}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <span className="font-syne font-bold text-xl tracking-tight">GALUNGGUNG</span>
          </div>
          ...
          <Button asChild className="bg-white text-black hover:bg-emerald-500 hover:text-white transition-all rounded-full px-6">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button asChild size="lg" className="bg-emerald-500 hover:bg-white text-black font-bold rounded-full px-10 py-7 text-lg group">
              <a href="#packages">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="font-syne text-4xl md:text-6xl font-bold mb-8 leading-tight">
                WE PROVIDE <br />
                THE GEAR, YOU <br />
                <span className="text-zinc-500 italic font-medium underline decoration-emerald-500/50">BRING THE VIBE.</span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <div className="text-4xl font-syne font-bold text-emerald-500 mb-1">1K+</div>
                  <div className="text-xs uppercase tracking-widest text-gray-500 font-bold">Happy Riders</div>
                </div>
                <div>
                  <div className="text-4xl font-syne font-bold text-emerald-500 mb-1">10+</div>
            ...
            <div className="relative group">
              ...
              <div className="absolute -bottom-6 -left-6 bg-emerald-500 p-8 rounded-2xl hidden md:block group-hover:-translate-y-2 transition-transform">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-xl">
              <div className="text-emerald-500 font-bold text-sm tracking-[0.3em] uppercase mb-4">Pricing & Plans</div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div 
                key={pkg.name} 
                className={`group relative p-8 rounded-3xl transition-all duration-500 ${pkg.primary ? "bg-emerald-500 text-black" : "bg-zinc-900 hover:bg-zinc-800"}`}
              >
                <div className="flex justify-between items-start mb-12">
                  <div className={`text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full ${pkg.primary ? "bg-black text-white" : "bg-emerald-500/10 text-emerald-500"}`}>
                    {pkg.tag}
                  </div>
                ...
                <Button asChild className={`w-full rounded-xl py-6 font-bold uppercase tracking-widest text-xs transition-all ${pkg.primary ? "bg-black text-white hover:bg-zinc-800" : "bg-white text-black hover:bg-emerald-500 hover:text-white"}`}>
      ...
      <section id="contact" className="py-32 bg-black border-t border-zinc-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20">
            <div>
              <h2 className="font-syne text-6xl md:text-8xl font-bold mb-10 tracking-tighter">GET IN <br /> <span className="text-emerald-500 underline decoration-white/20">TOUCH</span></h2>
              <div className="space-y-8">
                <div className="flex items-center gap-6 group">
                  <div className="bg-zinc-900 p-4 rounded-2xl group-hover:bg-emerald-500 transition-colors">
                    <MapPin className="h-6 w-6 text-emerald-500 group-hover:text-black" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-6 group">
                  <div className="bg-zinc-900 p-4 rounded-2xl group-hover:bg-emerald-500 transition-colors">
                    <Instagram className="h-6 w-6 text-emerald-500 group-hover:text-black" />
                  </div>
                  <div>
                    <div className="text-xs uppercase tracking-widest text-gray-500 font-bold mb-1">Follow Us</div>
                    <a href="https://instagram.com/galunggungjeeptrip" target="_blank" className="text-xl font-medium hover:text-emerald-500 transition-colors">@galunggungjeeptrip</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-zinc-900 p-12 rounded-[3rem] flex flex-col justify-center items-center text-center">
              <div className="bg-emerald-500/10 p-6 rounded-full mb-8 animate-bounce">
              ...
              <Button asChild size="lg" className="w-full bg-white text-black hover:bg-emerald-500 hover:text-white font-black py-8 rounded-2xl text-lg">
